...
void CMainFrame::OnHelpWorkflow()
{
	static const wchar_t kHelp[] =
		L"Краткий порядок\n\n"
		L"1. «Задание» → 1) Сборка: момент, валы, при необходимости «Табл. 21.3.1» — ОК.\n\n"
		L"2. Пункты 2) и 3): полумуфты — «Из ГОСТ» под вал.\n\n"
		L"3. Пункт 4): звёздочка — «Из ГОСТ».\n\n"
		L"4. «Подставить ГОСТ во все узлы» — обновить размеры по таблицам после смены момента или валов.\n\n"
		L"5. Дерево слева — превью; двойной клик — параметры узла.\n\n"
		L"6. «КОМПАС-3D: построить муфту» — экспорт в КОМПАС и сводка.\n\n"
		L"Файл → Сохранить — сохранить параметры в документе.";
